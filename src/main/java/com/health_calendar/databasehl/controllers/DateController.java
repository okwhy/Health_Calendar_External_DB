...
public class DateController {
    ...
    @PostMapping("/add/{id}")
    public DateDtoIDMutable add(@PathVariable Long id, @RequestBody DateDto1 dateDto) {
...
//    }
    ...
    public DateDtoIDMutable update(@PathVariable Long id,@RequestBody DateDto1 dateDto) {
        return dateService.updateDate(dateDto,id);}
    @GetMapping("/user/{id}")
